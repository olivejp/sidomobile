...
import nc.opt.sidomobile.graphic.OCRGraphic
...
class OCRFragment : Fragment(), ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private val mStateCallback = object : CameraDevice.StateCallback() {
        ...
        private fun createCameraPreviewSession() {
            try {
                ...
                mCameraDevice!!.createCaptureSession(Arrays.asList(surface, mImageReader!!.surface), captureStateCallback, null)
            } catch (e: CameraAccessException) {
                Log.e(TAG, e.localizedMessage, e)
            }
    ...
    private fun openCamera(width: Int, height: Int) {
        if (ContextCompat.checkSelfPermission(appCompatActivity!!, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
