 ...
 */
public class BarcodeTrackerFactory implements MultiProcessor.Factory<FirebaseVisionBarcode> {
    ...
    @Override
    public Tracker<FirebaseVisionBarcode> create(FirebaseVisionBarcode barcode) {
